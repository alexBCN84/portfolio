...
`<article id="${testimonials[i].id}">
  <a href="${testimonials[i].previous}" class="smooth-left"><i class="fa fa-angle-double-left"></i></a>
  <blockquote>
  ...
  <a href="${testimonials[i].next}" class="smooth-left"><i class="fa fa-angle-double-right"></i></a>
</article>`;
